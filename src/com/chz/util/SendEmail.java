...
public class SendEmail {
	//发件人的邮箱和授权码
	private final String myEmailAccount = "2435565917@qq.com";//发送的邮箱
	private final String myEmailPassword = "gjirgaxpzkhaeagf";
	...
	public  MimeMessage createMessage(Session session, String sendMail, String receiveMail,String info) throws Exception {
		...
		message.setSubject("医生审核信息", "UTF-8");
		// 5. Content: 邮件正文（可以使用html标签）（内容有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改发送内容）
		message.setContent("【医生审核结果】:"+info, "text/html;charset=UTF-8");
		// 6. 设置发件时间
